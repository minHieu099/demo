        ...
        sections: [
            {
                ...
                children: [
                    new Paragraph({
                        ...
                        children: [
                            new TextRun({
                                text: "TỔNG HỢP TÌNH HÌNH HOẠT ĐỘNG TRONG NGÀY " + data.thoigian,
                                size: 28,
                                bold: true,
                            }),
                        ],
                    ...
                    new Paragraph({
                        children: formatParagraph(3,["- Tổng quân số: " + data.tong_qs + ";", "- Quân số có mặt: " + data.qs_co_mat + ";", "- Quân số vắng mặt: " + data.qs_vang + ";", "- Lý do: " + data.ly_do + "."]),
                        tabStops: dotTab
                    }),
                    // new Paragraph({
                    //     children: [
